...
<div id="satu">
    <div id="satu_con">
        ...
        <div id="satu_b">
            <ul>
                <li><a href="index.php?page=home" <?php if($_GET['page'] == "home")echo " class=\"pilih\"" ?>>Home</a></li>
                <li><a href="index.php?page=tampil_biodata" <?php if($_GET['page'] == "tampil_biodata")echo " class=\"pilih\"" ?>>Biodata</a>
